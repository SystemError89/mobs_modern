...
--	Officer
mobs:register_mob("mobs_modern:moTAAof", {
	type = "armya", "ta", "npc",
	hp_min = 13,
	hp_max = 25,
	...
	textures = {
		{"TA_vil_pol1.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_g36"].inventory_image,},
		{"TA_vil_pol2.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_g36"].inventory_image,},
		{"TA_vil_pol3.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_m200"].inventory_image,},
		{"TA_vil_pol4.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_g36"].inventory_image,},
		{"TA_vil_pol5.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_g36"].inventory_image,},
--		{"TA_vil_pol6.png",		"3d_armor_trans.png",	minetest.registered_items["mobs_modern:weapon_g36"].inventory_image,},
	},
	visual_size = {x=1, y=.8},
...
--	Special Unit
mobs:register_mob("mobs_modern:moTAAsp", {
	type = "armya", "ta", "npc",
	hp_min = 29,
	hp_max = 43,
...
--	Agent
mobs:register_mob("mobs_modern:moTAAag", {
	type = "armya", "ta", "npc",
	hp_min = 29,
	hp_max = 43,
	collisionbox = {-0.3, -0.8, -0.3, 0.3, 0.8, 0.3},
...
mobs:register_spawn("mobs_modern:moTAva", {"mobs_modern:ntac"}, 5, 0, 10000, 1, 31000)

mobs:register_egg("mobs_modern:moTAAof", "Police Officer (moTA)", "default_leaves.png", 1)
--	mobs:register_egg("mobs_modern:moTAAsp", "SWAT Officer (moTA)", "default_leaves.png", 1)
--	mobs:register_egg("mobs_modern:moTAAag", "Agent (moTA)", "default_leaves.png", 1)